        ...
        "from": function(d) {
            return new function(d, c) {
                ...
                return 0 < d.length && (E = "object" != typeof d[0] ? !1 : !0), this._hasData = function() {
                    ...
                    var d = null == c ? a : c,
                        d = f ? b.trim(d.toString()).length : d.toString().length;
                    return E ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + d + "," + d + ') == "' + e._toStr(c) + '"') : e._append(e._getStr("this") + ".substr(" + e._getStr("this") + '.length-"' + e._toStr(a) + '".length,"' + e._toStr(a) + '".length) == "' + e._toStr(a) + '"'), e._setCommand(e.endsWith, a), e._resetNegate(), e
                }, this.contains = function(a, b) {
                    return E ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + e._toStr(b) + '",0) > -1') : e._append(e._getStr("this") + '.indexOf("' + e._toStr(a) + '",0) > -1'), e._setCommand(e.contains, a), e._resetNegate(), e
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var k = function(a, b) {
                            ...
                            y = function() {
                                function a(b) {
                                    ...
                                    if (null != b.rules) try {
                                        for ((e = b.rules.length && "OR" === b.groupOp.toString().toUpperCase()) && q.orBegin(), c = 0; c < b.rules.length; c++) g = b.rules[c], f = b.groupOp.toString().toUpperCase(), p[g.op] && g.field && (h > 0 && f && "OR" === f && (q = q.or()),
                                            q = p[g.op](q, f)(g.field, g.data, j[g.field])), h++;
                                        e && q.orEnd()
                                    } catch (k) {
                                        alert(k)
                                    }
                        ...
                        b(d).before(e.hDiv).click(function(a) {
                            ...
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0)
                                if (aa = Q[0].id, ba = b.jgrid.getCellIndex(P), ca = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [aa, ba, ca, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, aa, ba, ca, a), d.p.cellEdit === !0)
                                    if (d.p.multiselect && c) b(d).jqGrid("setSelection", aa, !0, a);
                                    else {
                                        aa = Q[0].rowIndex;
                                        try {
                                            b(d).jqGrid("editCell", aa, ba, !0)
                                        } catch (f) {}
                                    } else if (d.p.multikey) a[d.p.multikey] ? b(d).jqGrid("setSelection", aa, !0, a) : d.p.multiselect && c && (c = b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa).is(":checked"), b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa)[d.p.useProp ? "prop" : "attr"]("checked", c));
                            else {
                            ...
                            P = a.target, Q = b(P, d.rows).closest("tr.jqgrow"), 0 !== b(Q).length && (aa = Q[0].rowIndex, ba = b.jgrid.getCellIndex(P), b(d).triggerHandler("jqGridDblClickRow", [b(Q).attr("id"), aa, ba, a]), b.isFunction(d.p.ondblClickRow) && d.p.ondblClickRow.call(d, b(Q).attr("id"), aa, ba, a))
                        }).bind("contextmenu", function(a) {
                            P = a.target, Q = b(P, d.rows).closest("tr.jqgrow"), 0 !== b(Q).length && (d.p.multiselect || b(d).jqGrid("setSelection", Q[0].id, !0, a), aa = Q[0].rowIndex, ba = b.jgrid.getCellIndex(P), b(d).triggerHandler("jqGridRightClickRow", [b(Q).attr("id"), aa, ba, a]), b.isFunction(d.p.onRightClickRow) && d.p.onRightClickRow.call(d, b(Q).attr("id"), aa, ba, a))
                        ...
                        var da = !0 === d.p.hidegrid ? b("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton' />").hover(function() {
                        ...
                        if (b(e.cDiv).append(da).append("<span class='ui-jqgrid-title" + ("rtl" === g ? "-rtl" : "") + "'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix"), b(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0] && (e.uDiv = document.createElement("div"), "top" === d.p.toolbar[1] ? b(e.uDiv).insertBefore(e.hDiv) : "bottom" === d.p.toolbar[1] && b(e.uDiv).insertAfter(e.hDiv), "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"), b(e.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(e.hDiv), b(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(e.hDiv), _ && b(e.ubDiv).hide()) : b(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), _ && b(e.uDiv).hide()), d.p.toppager && (d.p.toppager = b.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = b("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, b(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv), D(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], f = b("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>"), b(e.sDiv).append(f).width(e.width).insertAfter(e.hDiv), b(f).append(Y), e.footers = b(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = "ui-state-default jqgrid-rownum"), _ && b(e.sDiv).hide()), f = null, d.p.caption) {
                            ...
                            !0 === d.p.hidegrid && (b(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                                ...
                                return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (g += ", #" + b(e.ubDiv).attr("id")), g += ", #" + b(e.uDiv).attr("id")), c = b(g, "#gview_" + b.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? b(g, "#gbox_" + b.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                                    ...
                                    c--, 0 === c && (b("span", h).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"), _ && (d.p.datatype = ea, B(), _ = !1), d.p.gridstate = "visible", b("#gbox_" + b.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && b(".ui-resizable-handle", "#gbox_" + b.jgrid.jqID(d.p.id)).show(), b(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), f && (_ || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                                }), !1
                    ...
                    if (l && l > 0) {
                        for (; l > m;) {
                            if (b(this.rows[m]).hasClass("jqgrow")) {
                                ...
                                d ? (h = parseFloat(e), isNaN(h) || (j += h, void 0 === g && (g = f = h), f = Math.min(f, h), g = Math.max(g, h), n++)) : c ? i.push({
                                    "id": this.rows[m].id,
                                    "value": e
                                }) : i.push(e)
                            }
        ...
        "sortGrid": function(a, b, c) {
            return this.each(function() {
                var d, e = -1,
                    f = !1;
                if (this.grid) {
                    for (a || (a = this.p.sortname),
                        d = 0; d < this.p.colModel.length; d++)
...
function(a) {
    a.extend(a.jgrid, {
        ...
        "checkDate": function(a, b) {
            ...
            var e, f, g = -1,
                h = -1;
            for (f = 0; f < a.length; f++) e = isNaN(b[f]) ? 0 : parseInt(b[f], 10), d[a[f]] = e,
                e = a[f], -1 !== e.indexOf("y") && (c = f), -1 !== e.indexOf("m") && (h = f), -1 !== e.indexOf("d") && (g = f);
                            ...
                            if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                                ...
                                switch (o.p.autoencode && (g = a.jgrid.htmlDecode(g)), (!0 === b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                    ...
                                    case "select":
                                        ...
                                        break;
                                    case "checkbox":
                                        g = "" + g, m[h].editoptions && m[h].editoptions.value ? m[h].editoptions.value.split(":")[0] === g ? a("#" + f, "#" + e)[o.p.useProp ? "prop" : "attr"]({
                                            "checked": !0,
                                            "defaultChecked": !0
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function() {
                        ...
                        for (o.append(u), u.bind("change", function() {
                                ...
                                "nu" === b.op || "nn" === b.op ? (b.data = "", "SELECT" !== c.tagName.toUpperCase() && (c.value = ""), c.setAttribute("readonly", "true"), c.setAttribute("disabled", "true")) : ("SELECT" === c.tagName.toUpperCase() && (b.data = c.value),
                                    c.removeAttribute("readonly"), c.removeAttribute("disabled")), l.onchange()
        ...
        "groupingSetup": function() {
            return this.each(function() {
                ...
                if (null === e || "object" != typeof e && !a.isFunction(e)) this.p.grouping = !1;
                    ...
                    for (e.summary = [], b = 0, c = d.length; c > b; b++) d[b].summaryType && (d[b].summaryDivider ? e.summary.push({
                        "nm": d[b].name,
                        "st": d[b].summaryType,
                        "v": "",
